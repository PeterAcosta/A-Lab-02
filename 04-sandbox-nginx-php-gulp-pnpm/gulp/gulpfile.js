...
// IMAGES
// responsive images : https://github.com/khalyomede/gulp-sharp-responsive
function img_responsive(){
    return src( IMGfiles + '*.{png,jpg}' )
...
exports.all = parallel( min_js , min_css , min_html , min_php_functions , min_php_classes , img_responsive );
...
exports.default = function() {
    ...
    watch( IMGfiles + '*.{png,jpg}' , {ignoreInitial:false} , img_responsive  );
